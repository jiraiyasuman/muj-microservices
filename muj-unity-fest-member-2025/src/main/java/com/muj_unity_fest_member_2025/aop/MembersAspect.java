package com.muj_unity_fest_member_2025.aop;
...
@Aspect
@Component
public class MembersAspect {

	// setup the Logger
			private Logger LOGGER = Logger.getLogger(getClass().getName());
		    // setup pointcut declarations
			@Pointcut("execution(* com.muj_unity_fest_member_2025.controller.*.*(..))")
			private void forControllerPackage() {
				LOGGER.info("LoginUserController class is being executed");
			}
			@Pointcut("com.muj_unity_fest_member_2025.*.*(..))")
